export default {
  ...
  'iceworks.project.panel.router.title.redirect': '重定向',
  ...
  'iceworks.project.panel.router.form.path.tip': '填写路径地址，以 / 开头，如果没填，当在浏览器访问不存在的路径会跳转到下面选择的组件',
  ...
  'iceworks.project.panel.router.form.redirect': '重定向',
  'iceworks.project.panel.router.form.redirect.tip': '如果填写了重定向路径，访问上面填写的路径将会跳转',
